...
- `requirements.txt` with the Day 1 through Day 47 Python dependencies.
- `clinical_vector_db/` as a local ignored ChromaDB runtime artifact generated by the Day 30 script.
- `clinical_rag_db/` as a local ignored ChromaDB runtime artifact generated by the Day 45 through Day 47 RAG database scripts.
...
# 2. Install Day 1 through Day 47 dependencies
